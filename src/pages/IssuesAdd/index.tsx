...
import { IssueData, IssuePriority, IssueType } from "../../interfaces/Issue";
...
const issueTypes: IssueType[] = ["bug", "feature request", "improvement"];
const issuePriorities: IssuePriority[] = ["high", "medium", "low"];
